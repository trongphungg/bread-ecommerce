                    ...
                    <div class="card-body">
                        <form action="{{ route('handleUpdateUser',$user->idkhachhang) }}" method="POST">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="date" class="form-control" name="ngaysinh" value="{{ \Carbon\Carbon::parse($user->ngaysinh)->format('Y-m-d') }}">
                            </div>
                            <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control form-select" name="trangthai" >
                                    <option value="1" {{ $user->trangthai == '1' ? 'selected' : '' }}>Đang hoạt động</option>
                                    <option value="0" {{ $user->trangthai == '0' ? 'selected' : '' }}>Bị khoá</option>
                                </select>
                            </div>
                            <div class="form-group col-md-6">
                                <label>Vai trò</label>
