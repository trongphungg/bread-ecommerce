                    ...
                    <form class="mt-3" action="{{ route('handleUpdateNews', $tintuc->idtintuc) }}" method="POST"
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <textarea class="form-control" name ="mota" aria-label="With textarea" required>{{$tintuc->mota}}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="email2">Ngày tạo</label>
                            <input type="date" class="form-control" name ="ngaytao" value="{{ $tintuc->ngaytao }}"
                                required />
                        </div>
                        <div class="form-group">
                            @if ($tintuc->hinhanh)
