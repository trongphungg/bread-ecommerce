                        ...
                        <div class="card-body">
                            <div class="row align-items-center">
                                ...
                                <div class="col col-stats ms-3 ms-sm-0">
                                    <div class="numbers">
                                        <p class="card-category">Đơn đang chờ xác nhận</p>
                                        <h4 class="card-title">{{ $tongCXN}}</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card card-stats card-round">
                        <div class="card-body">
                            <div class="row align-items-center">
                                ...
                                <div class="col col-stats ms-3 ms-sm-0">
                                    <div class="numbers">
                                        <p class="card-category">Đơn hàng hoàn tất</p>
                                        <h4 class="card-title">{{ $tongHT }}
                                        </h4>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="row">
      <div class="card">
        <table class="mt-3 table table-hover">
          ...
          @foreach($dsdh as $dh)
          <tr>
              <td>{{ $dsdh->firstItem() + $loop->index }}</td>
              <td>
                {{$dh->tenkhachhang}}
              </td>
              <td>
