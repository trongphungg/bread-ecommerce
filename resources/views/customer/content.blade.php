    ...
    <div class="row align-items-center mb-5">
        ...
        <div class="col-lg-6 mb-4 mb-lg-0 animate__animated">
            <div class="rounded-3 overflow-hidden h-100">
                <img src="{{ asset('customer/assets/img/'.$content->hinhanh) }}" class="img-fluid w-100 h-100 object-fit-cover" alt="">
            </div>
        </div>
        ...
        <div class="col-lg-6 order-lg-2 mb-4 mb-lg-0 animate__animated">
            <div class="rounded-3 overflow-hidden h-100">
                <img src="{{ asset('customer/assets/img/'.$content->hinhanh) }}" class="img-fluid w-100 h-100 object-fit-cover" alt="About Us">
            </div>
        </div>
