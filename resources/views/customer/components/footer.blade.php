            ...
            <div class="row g-4 col-sm-12">
                <div class="col-lg-6">
                    <a href="#" class="text-decoration-none">
                        ...
                        <p class="orange-color mb-0">Sản phẩm thơm ngon</p>
                    </a>
                </div>
                <div class="col-lg-3">
                ...
                <div class="col-lg-3">
                    <div class="d-flex justify-content-end pt-3">
                        ...
                        <a class="btn btn-outline-secondary me-2 btn-md-square rounded-circle"
                            href="https://www.facebook.com/TrongPhungg" target="_blank"><i
        ...
        <div class="row g-5">
            <div class="col-lg-3">
                <div class="footer-item">
                    ...
                    <p class="mb-4">Bánh mì của chúng tôi được làm từ nguyên liệu tươi ngon, công thức chuẩn vị và sự
                        tận tâm.
                        Từng ổ bánh là sự hòa quyện hoàn hảo giữa vỏ giòn rụm, nhân đậm đà và rau thơm tươi mát.</p>
            ...
            <div class="col-lg-3">
                <div class="footer-item">
                    ...
                    <p>Địa chỉ: 180 Cao Lỗ, phường 04, quận 8, TP.HCM</p>
                    <p>Email: trongphung020103@gmail.com</p>
                    <p>Phone: 0338 737 003</p>
                    <img src="{{ asset('customer/assets/img/payment.png') }}" class="img-fluid" alt="">
                </div>
            </div>
        </div>
    </div>
